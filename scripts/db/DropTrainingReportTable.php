...
class DropTrainingReportTable extends AbstractAction
{
    public function __invoke($params)
    {
        ...
        return $this->dropTable($persistence);
    }

    private function dropTable(common_persistence_SqlPersistence $persistence): Report
    {
        try {
            ...
            // Perform changes.
            $schema->dropTable(TrainingReportService::TABLE_NAME);

            // Execute schema transformation.
            $persistence->getPlatForm()->migrateSchema($fromSchema, $schema);

            $successMsg = '`training_reports` table was successfully deleted.';
